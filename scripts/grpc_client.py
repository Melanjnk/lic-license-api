...
from ozonmp.lic_license_api.v1.lic_license_api_grpc import OmpTemplateApiServiceStub
from ozonmp.lic_license_api.v1.lic_license_api_pb2 import DescribeTemplateV1Request
